...
* config netowrk ACO route table
...
* create serveless website (like using poly)
...
* use that sort of model and visualize and automate

X-Ray
* debug
* analyze your serverless application
* requests tracing, can go in and find the root cause of issue and performance bottlenecks
